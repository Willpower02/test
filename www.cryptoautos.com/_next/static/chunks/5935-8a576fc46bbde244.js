    ...
    [5935], {
        13313: function(e, t) {
            ...
            n = (e, t) => {
                ...
                }), d.forEach(e => n.insertBefore(e, r)), r.content = (a - i.length + d.length).toString()
        ...
        85935: function(e, t, n) {
            ...
            let r = n(84096),
                ...
                h = e => {
                    ...
                    for (let [n, r] of (o ? (_.innerHTML = o.__html || "", m()) : a ? (_.textContent = "string" == typeof a ? a : Array.isArray(a) ? a.join("") : "", m()) : t && (_.src = t, c.set(t, b)), Object.entries(e))) {
                        if (void 0 === r || p.includes(n)) continue;
                        let e = d.DOMAttributeNames[n] || n.toLowerCase();
                        _.setAttribute(e, r)
                    }
                    "worker" === i && _.setAttribute("type", "text/partytown"), _.setAttribute("data-nscript", i), s && y(s), document.body.appendChild(_)
                };
            ...
            function b(e) {
                ...
                let M = (0, i.useRef)(!1);
                if ((0, i.useEffect)(() => {
                        !M.current && ("afterInteractive" === d ? h(e) : "lazyOnload" === d && ("complete" === document.readyState ? (0, s.requestIdleCallback)(() => h(e)) : window.addEventListener("load", () => {
                            (0, s.requestIdleCallback)(() => h(e))
                        })), M.current = !0)
                    }, [e, d]), ("beforeInteractive" === d || "worker" === d) && (m ? (_[d] = (_[d] || []).concat([{
                        id: t,
                        src: n,
                        onLoad: r,
                        onReady: l,
                    ...
                    if (p && p.forEach(e => {
                        ...
                        }), "beforeInteractive" === d) return n ? (a.default.preload(n, y.integrity ? {
                        as: "script",
                    ...
                    "afterInteractive" === d && n && a.default.preload(n, y.integrity ? {
                        as: "script",
                        integrity: y.integrity
                    } : {
                        as: "script"
