! function() {
    var e = [, function(e, t, i) {
            ...
            function I() {
                if ((0, a.hasRequiredFeatures)(window)) {
                    const e = (0, m.getFullUrl)("app-api"),
                        t = (0, m.getFullUrl)("api");
                    if (!new RegExp(`^(${e}|${t})/conversations/assistants/v1/content-embed`, "i").test(window.location.href)) {
                        const e = new p.ErrorLogger;
                        (0, f.getIsLocal)() ? v(): e.captureErrors((() => {
                            v(e)
                        }))
                    }
                }
            ...
            class ne {
                constructor(e, t, i) {
                    ...
                    this.loadIFrame = () => {
                        ...
                        (0, n.isAnyMobile)() && document.documentElement.classList.add(p.MOBILE);
                        ...
                        if ((0, R.shouldEmbedInline)()) {
                            const i = document.querySelector((0, R.getInlineEmbedSelector)());
                            if (!i) {
                                this.devLogger.error(`cannot embed widget - element at \`${(0,R.getInlineEmbedSelector)()}\` cannot be found`);
                                return
                            }
                        ...
                        r.className = p.SHADOW_CONTAINER;
                    ...
                    this.scrollPercentageTracker = new M.default({
                        onScroll: this.handleScroll
                    });
                    this.exitIntentTracker = new D.default({
                        onExitIntent: this.handleExitIntent
                    });
                    this.iframeMessage = (0, $.iframeMessagePool)({
                ...
                removeIframe() {
                    this.unintializeDrag();
                    const e = (0, R.shouldEmbedInline)() ? document.getElementById(I.INLINE_PARENT_ID) : document.getElementById(I.PARENT_ID);
                    e && e.remove();
                    this.iframeSrc = null;
                    this.hasLoadedIframe = !1;
                    this.isLoadingIframe = !1
                ...
                handleOpenChange({
                    ...
                    const i = document.documentElement,
                        s = document.getElementById(I.PARENT_ID).getElementsByClassName(p.SHADOW_CONTAINER)[0];
                    this.isOpen = e;
                ...
                handleWidgetRefresh(e) {
                    this.setWidgetData(e);
                    (0, d.getWidgetDataResponseType)(this.widgetData) === f.HIDE_WIDGET ? this.removeIframe() : this.iframeMessage.post(r.REFRESH_WIDGET_DATA, Object.assign({}, this.widgetData, (0, w.getIframeQueryParams)(this.embedScriptContext)))
                }
                setWidgetNotLoaded({
                    reason: e,
                    description: t
                ...
                loadWidget(e = {}) {
                    ...
                    if (this.isLoadingIframe) this.devLogger.log("Cannot load the widget - The widget is already being loaded.");
            ...
            function v(e) {
                ...
                var v = t.userAgent,
                    I = v.split("[FBAN");
                void 0 !== I[1] && (v = I[0]);
                void 0 !== (I = v.split("Twitter"))[1] && (v = I[0]);
                var b = _(v),
                    T = {
                        apple: {
                            phone: b(i) && !b(c),
                            ipod: b(s),
                            tablet: !b(i) && (b(n) || E(t)) && !b(c),
                            universal: b(o),
                            device: (b(i) || b(s) || b(n) || b(o) || E(t)) && !b(c)
                        },
                        amazon: {
                            phone: b(l),
                            tablet: !b(l) && b(d),
                        ...
                        android: {
                            phone: !b(c) && b(l) || !b(c) && b(r),
                            tablet: !b(c) && !b(l) && !b(r) && (b(d) || b(a)),
                            device: !b(c) && (b(l) || b(d) || b(r) || b(a)) || b(/\bokhttp\b/i)
                        },
                        windows: {
                            phone: b(c),
                            tablet: b(u),
            ...
            function d({
                ...
                pathname: d = window.location.pathname
            }) {
                const c = -1 !== d.indexOf(l) && !r.test(d),
                    u = a.test(d);
                return !(!o.test(t) || c || u) && (-1 !== t.indexOf("qa") ? e === i || e === s || e === n : e === i)
            }
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            t.shouldLoadImmediately = t.shouldHideScrollToButton = t.shouldHideNewThreadLink = t.shouldEmbedInline = t.shouldDisableInitialInputFocus = t.shouldDisableAttachment = t.shouldBeFullscreen = t.getInlineEmbedSelector = t.getIdentificationToken = t.getIdentificationEmail = t.getEnableWidgetCookieBanner = void 0;
            var s = i(33);
            ...
            const p = () => (0, s.getExternalApiSettings)().hideNewThreadLink;
            t.shouldHideNewThreadLink = p
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            function d() {
                ...
                (0, n.booleanInvariant)(t.hideNewThreadLink, "mergedSettings.hideNewThreadLink");
            ...
            class i {
                ...
                log(e) {
                    this._isDebugMode() && console.log(`${i.LOGGING_PREFIX} ${e}`)
                }
                error(e) {
                    this._isDebugMode() && console.error(`${i.LOGGING_PREFIX} ${e}`)
                }
            }
            i.LOGGING_PREFIX = "HubSpot Conversations log:";
            t.default = i;
            e.exports = t.default
        }, function(e, t, i) {
            "use strict";
            ...
            t = function() {
                return function e(t, i, s) {
                    ...
                    for (var o = void 0, r = 0; r < s.length; r++) n(s[r]);
                    return n
                }({
                    1: [function(e, t, i) {
            ...
            t.WIDGET_LOADED = t.WIDGET_HIDDEN = t.WIDGET_CLOSED = t.USER_SELECTED_THREAD = t.USER_INTERACTED_WITH_WIDGET = t.UNREAD_CONVERSATION_COUNT_CHANGED = t.SDK_CLOSE_BUTTON_CLICK = t.QUICK_REPLY_BUTTON_CLICK = t.INPUT_STAGING = t.CONVERSATION_STARTED = t.CONVERSATION_CLOSED = t.CONTACT_ASSOCIATED = void 0;
            ...
            t.doRequest = n;
            t.get = n("GET"), t.post = n("POST"), t.put = n("PUT")
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            const i = e => e.replace(/ +/g, "_"),
                s = e => `https://cdn1.hubspot.net/googlefonts/fonts/${i(e)}/regular.woff2`,
                n = e => {
            ...
            t.isSafari = void 0;
            var i;
            const s = null === (i = window) || void 0 === i || null === (i = i.navigator) || void 0 === i || null === (i = i.userAgent) || void 0 === i ? void 0 : i.toLowerCase(),
                n = () => (null == s ? void 0 : s.includes("safari/")) && !(null != s && s.includes("chrome/")) && !(null != s && s.includes("edge/"));
            t.isSafari = n
        }, function(e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            e.exports = "//static.hsappstatic.net/conversations-embed/static-1.20644/sass/messagesWidgetShell.sass"
        }, function(e) {
            ...
            function n() {
                ...
                return null == t || !t.getRandomValues || null !== (e = window) && void 0 !== e && e.Uint16Array ? i() : s()
            }
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            t.UTK_REGEX = void 0;
            t.isUtk = s;
            const i = t.UTK_REGEX = /[a-zA-Z\d]{32}/;
            ...
            t.getPortalId = i;
            const s = () => document.getElementById("hubspot-messages-loader").getAttribute("data-hsjs-env");
            t.getMessagesEnv = s;
            const n = () => document.getElementById("hubspot-messages-loader").getAttribute("data-hsjs-hublet");
            t.getMessagesHublet = n;
            const o = () => "true" === document.getElementById("hubspot-messages-loader").getAttribute("data-hsjs-local");
            t.getIsLocal = o;
            ...
            function c({
                ...
                return `/_hcms/livechat/widget${d({messagesUtk:e,hubspotUtk:t,portalId:i,referrer:s,hstc:n,hssc:o,email:r,identificationToken:a})}`
            }
            ...
            t.default = void 0;
            const i = ["api", "local", "app", "private", "platform", "tools", "meetings"],
                s = ["hubspotstarter", "hubspotfree", "hubspotemail"],
                n = ["growth"],
                o = {
                ...
                r = function e(t) {
                    const s = new RegExp(`^(?!local|test|selenium)(.*\\.)?(${Object.entries(o).map((([e,t])=>`(?:${t})(qa)?\\.${e}`)).join("|")}|(?:connect)\\.com|(?:connect)(qa)\\.co|wthubspot\\.(com|de|es|fr|jp))$`).test(t.hostname),
                        n = new RegExp(`${Object.entries(o).map((([e,t])=>`(?:${t})qa\\.${e}`)).join("|")}|(?:connect)qa\\.co|wthubspot\\.(com|de|es|fr|jp)|hsqa-sales(?:crm)?-sub\\.com|(?:hubspotstarter|hubspotfree|hubspotemail)(qa)(?:-.*)\\.net|(?:hubspotemail)(qa)(?:-.*)\\.com`),
                        r = [new RegExp(`^(?:${i.join("|")})-(.*).(?:hubspot|hubteam)(?:qa)?.com`), new RegExp("^(.*).(?:hubspotquote)(?:qa)?.com"), new RegExp("^app-(.*).(?:hubspotdocuments)(?:qa)?.com"), new RegExp("^(?:[0-9]+).(.*).hs(?:qa)?-sales(?:crm)?-sub.com"), new RegExp("^hs-(?:[0-9]+).s.(?:hubspotfree|hubspotstarter|hubspotemail)(?:qa)?-(.*).net"), new RegExp("^hs-(?:[0-9]+).s.(?:hubspotemail)(?:qa)?-(.*).com"), new RegExp("^t.sidekickopen(?:\\d)+-([a-z]+[0-9]).com"), new RegExp("^([a-z]+[0-9]).hs-data-privacy(?:qa)?.com")],
                        a = "ENV",
            ...
            e.exports = {
                ...
                bender: {
                    ...
                    depPathPrefixes: {
                        "conversations-embed": "/conversations-embed/static-1.20644",
                        ...
                        "hubspot-url-utils": "/hubspot-url-utils/static-1.1665",
                        ...
                        "metrics-js": "/metrics-js/static-1.6511",
            ...
            t.getChatflowTagFromQueryParams = i;
            ...
            const i = e => Object.keys(e).map((t => [t, `${e[t]}`]));
            t.withValuesConvertedToString = i;
            const s = e => new URLSearchParams(i(e)).toString();
            t.serializeQueryParameters = s
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            function a({
                ...
                try {
                    const i = "qa" === t ? "qa" : "",
                        ...
                        p = Boolean(document.querySelector(`script[src^="${l}"]`));
            ...
            t.isInSDK = void 0;
            const i = () => /\bHub[sS]pot ?Mobile ?SDK\b/.test(window.navigator.userAgent);
            t.isInSDK = i
        }, function(e, t) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            function s(e) {
                return ["function" == typeof e.WeakMap, "function" == typeof e.requestAnimationFrame, "function" == typeof e.URLSearchParams, "function" == typeof Object.fromEntries, i()].every((e => e))
            }
        }, function(e, t, i) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            var s = i(123),
                n = i(103);
            const o = "https://exceptions.hubspot.com/v2/api/store/?sentry_key=7ab6425e7a7c4b01b71fdb51e76514bf&sentry_version=7&sentry_client=raven-js%2F3.19.1",
                r = 4;
            ...
            function o(e) {
                ...
                for (let s = 0, p = d.length; s < p; ++s) {
                    if (h = t.exec(d[s])) {
                        ...
                        if (!(h = r.exec(d[s]))) continue;
                        if (h[3] && h[3].indexOf(" > eval") > -1 && (u = a.exec(h[3]))) {
                            h[3] = u[1];
                            h[4] = u[2];
                            h[5] = null
                        } else 0 !== s || h[5] || void 0 === e.columnNumber || (c[0].column = e.columnNumber + 1);
                        g = {
                            filename: h[3],
                            function: h[1] || i,
                            args: h[2] ? h[2].split(",") : [],
                    ...
                    }!g.function && g.line && (g.function = i);
            ...
            function a(e, t) {
                const n = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,
                    ...
                    d = {};
                let c, u, h = !1;
                for (let e = a.caller; e && !h; e = e.caller)
                    if (e !== l) {
                        u = {
                            filename: null,
                            function: i,
                        ...
                        e.name ? u.function = e.name : (c = n.exec(e.toString())) && (u.function = c[1]);
    ...
    function i(s) {
        ...
        e[s].call(o.exports, o, o.exports, i);
        return o.exports
    }! function() {
        "use strict";
        var e = i(1);
        ...
        "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", t) : (0, e.startOnceReady)()
    }()
}();
//# sourceMappingURL=//static.hsappstatic.net/conversations-embed/static-1.20644/bundles/project.js.map